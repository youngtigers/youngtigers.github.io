%%
%%  L = loglik_K3(omegabar, y, z, sigvhat, pi) 
%%
%%  "loglik_K3" computes negative of log-likelihood function
%%  used in step 4 of the estimation alogorithm for the case where
%%  c - u_i has NO group structure, assuming there's 3 groups for
%%  vartheta hat
%%
%%  [Model]
...
function L = loglik_K3(omegabar, y, z1, z2, z3, sigvhat_g1, sigvhat_g2, sigvhat_g3, pi_g1, pi_g2, pi_g3, K_sieves ) 

% sort response and covariates into three groups based on HAC
y_g1  =  y(K_sieves==1,:);
...
sqrt_s_v3 = sqrt(sigvhat_g3); % sqrt_s_v3 is the square root of sigma_v; note sigvhat = sqrt(sigv2hat_g2)
s_v1 = sqrt_s_v1^2;
s_v2 = sqrt_s_v2^2;
s_v3 = sqrt_s_v3^2;
